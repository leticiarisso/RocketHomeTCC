...
<html lang="en">
  ...
  <div x-data="setup()" x-init="$refs.loading.classList.add('hidden'); setColors(color);" :class="{ 'dark': isDark}">
      <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        ...
        <h1 class="py-4 text-dark rounded"></i> Cadastrar Franqueado</h1>
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                ...
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-book'></i>","Nome", "book_name",""); ?>
                </div>
                <div class="row pt-2">
                    <div class="col">
                        <?php inputElement("<i class='fas fa-envelope'></i>","Email", "book_publisher",""); ?>
                    </div>
                    <div class="col">
                ...
                <div class="d-flex justify-content-center">
                        ...
                        <?php buttonElement("btn-deleteall","btn btn-danger","<i class='fas fa-user-times'></i>","deleteall","data-toggle='tooltip' data-placement='bottom' title='Delete'"); ?>
                        <?php deleteBtn();?>
                </div>
            </form>
        </div>
            ...
            <table class="table table-striped ">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $f['book_name']?>
                        </td>
                        <td>
                            <?php echo $f['book_publisher']?>
                        </td>
                        <td>
                            <?php echo $f['book_price']?>
                        </td>
                    </tr>
                    <?php
                }
