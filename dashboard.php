...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="dashboard/public/build/images/logo.png" type="image/x-png"/>
    <title>Dashboard</title>
    <link
      href="https://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;600;700;900&display=swap"
      rel="stylesheet"
    />
    <link rel="stylesheet" href="dashboard/public/build/css/tailwind.css" />
  ...
  <body>
            ...
            <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
              ...
              <div x-data="{ isActive: false, open: false }">
                ...
                >
                  ...
                  <span class="ml-2 text-sm"> Controle </span>
        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
          ...
          <header class="relative bg-white dark:bg-darker">
            <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
              ...
              >
              <img class="logo" src="dashboard/public/build/images/Logo2.png" alt="logo" style="width:200px">
              </a>
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="<?php echo $f['image']?>"/>
                  </button>
              ...
              >
                ...
                <div class="relative ml-auto" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="<?php echo $f['image']?>" alt="Ahmed Kamel" />
                  </button>
              ...
              <nav aria-label="Main" class="px-2 py-4 space-y-2">
                ...
                <div x-data="{ isActive: false, open: false }">
                  ...
                  <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Pages">
                    ...
                    <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                    <a
                      href="dashboard/public/pages/blank.html"
                      role="menuitem"
                      class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                    >
                      Blank
                ...
                <div x-data="{ isActive: false, open: false}">
                  ...
                  <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Layouts">
                    ...
                    <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                    <a
                      href="dashboard/public/layouts/two-columns-sidebar.html"
                      role="menuitem"
                      class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                    >
                      Two Columns Sidebar
                    ...
                    <a
                      href="dashboard/public/layouts/mini-plus-one-columns-sidebar.html"
                      role="menuitem"
                      class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                    >
                    ...
                    <a
                      href="dashboard/public/layouts/mini-column-sidebar.html"
                      role="menuitem"
                      class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                    >
                      Mini Column Sidebar
              ...
              <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
                ...
                <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                  ...
                  <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                    <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Gráficos</h4>
                    <div class="flex items-center space-x-2">
                      <span class="text-sm text-gray-500 dark:text-light">Último ano</span>
                      <button
                ...
                <div class="bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                  <!-- Card header -->
                  <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                    <h4 class="text-lg font-semibold text-gray-500 dark:text-light"></h4>
              ...
              <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
                ...
                <div class="col-span-1 bg-white rounded-md dark:bg-darker">
                  ...
                  <div class="p-4 border-b dark:border-primary">
                    <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Usuários online</h4>
                  </div>
                  <p class="p-4">
                    <span class="text-2xl font-medium text-gray-500 dark:text-light" id="usersCount">0</span>
                    <span class="text-sm font-medium text-gray-500 dark:text-primary">Usuários</span>
                  </p>
                  <!-- Chart -->
                ...
                <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                  <!-- Card header -->
                  <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                    <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Gráfico de Linha</h4>
                    <div class="flex items-center">
                      <button
                        class="relative focus:outline-none"
                        x-cloak
          ...
          >
            <div>RocketHome &copy; 2021</div>
            <div>
              
              <a href="https://www.instagram.com/lett.xe/" target="_blank" class="text-blue-500 hover:underline">Letícia Risso</a>
              <!--<a href="https://www.instagram.com/lett.xe/" target="_blank" class="text-blue-500 hover:underline">Brenno</a>
              <a href="https://www.instagram.com/lett.xe/" target="_blank" class="text-blue-500 hover:underline">Mateus</a>-->
            </div>
          </footer>
        </div>
              ...
              <div class="space-y-4" x-show.transition.in="activeTabe == 'action'">
                  ...
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">
                        New project "RocketHome" created
                      </h5>
                ...
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">
                        RocketHome v0.0.2 was released
                      </h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                    ...
                    <div class="relative flex-shrink-0">
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        <img
                          ...
                          src="dashboard/public/build/images/teus.jpeg"
                        />
                      </span>
                      <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
                    </div>
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Mateus Risso</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                        Compartilhou novo projeto "RocketHome"
                      </p>
                      <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> 1d atrás </span>
                    </div>
                  </div>
                </a>
                  ...
                  <div class="flex px-4 space-x-4">
                    <div class="relative flex-shrink-0">
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        <img
                          class="object-cover rounded-full w-9 h-9"
                          src="dashboard/public/build/images/brenno.jpeg"
                        />
                      </span>
                      <div class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker"></div>
                    </div>
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Brenno Benuto</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                        Atribuiu novas mudanças para o projeto RocketHome.
                      </p>
                      <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> 10h atrás </span>
                    </div>
                  </div>
                </a>
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light"><?php echo $f['name']?></h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                        Compartilhou nova versão "RocketHome"
                      </p>
                      <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> 20d atrás </span>
                    </div>
                  </div>
                </a>
        ...
        >
          ...
          <div class="flex flex-col h-screen">
            ...
            <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
              <h3 class="py-2 text-sm font-semibold text-gray-600 dark:text-light">Histórico</h3>
              
                
              <a href="#" class="flex space-x-4">
                <div class="flex-shrink-0">
                  <img class="w-10 h-10 rounded-lg" src="dashboard/public/build/images/logo.png" alt="K-WD Dashboard" />
                </div>
                <div class="flex-1 max-w-xs overflow-hidden">
                  <h4 class="text-sm font-semibold text-gray-600 dark:text-light">RocketHome Dashboard</h4>
                  <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                    Os gráficos estão subindo!
                  </p>
                  <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> Atualizou 1h atrás. </span>
                </div>
              </a>
              <template x-for="i in 10" x-key="i">
                <a href="#" class="flex space-x-4">
                  ...
                  <div class="flex-1 max-w-xs overflow-hidden">
                    ...
                    <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> Atualizou 3h atrás. </span>
                  </div>
                </a>
              </template>
            </div>
    ...
    <script src="dashboard/public/build/js/script.js"></script>
    <script>
      const setup = () => {
        const getTheme = () => {
